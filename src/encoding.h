...
#define WG_KEY_LEN_BASE58 (((((WG_KEY_LEN) + 3) / 4) * 5) + 1)
...
void key_to_base58(char base64[static WG_KEY_LEN_BASE58], const uint8_t key[static WG_KEY_LEN]);
bool key_from_base58(uint8_t key[static WG_KEY_LEN], const char *base64);
